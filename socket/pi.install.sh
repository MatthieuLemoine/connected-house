...
cd /tmp && wget https://nodejs.org/dist/latest-v5.x/node-v5.3.0-linux-armv6l.tar.gz;
tar -xzf node-v5.3.0-linux-armv6l.tar.gz;
sudo rm node-v5.3.0-linux-armv6l.tar.gz;
sudo rm -R /opt/nodejs/node-v5.3.0-linux-armv6l/;
sudo mv node-v5.3.0-linux-armv6l/ /opt/nodejs/;
